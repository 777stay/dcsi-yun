...
@Slf4j
@Component
public class GlobalStatusWebSocketHandler extends TextWebSocketHandler {

    private final Map<String, WebSocketSession> sessions = new ConcurrentHashMap<>();
    
    @Autowired // 使用延迟注入避免循环依赖
    private GlobalRobotStatusService statusService;
    ...
    public void afterConnectionEstablished(WebSocketSession session) throws Exception {
        ...
        session.sendMessage(new TextMessage(statusService.getAllStatusesAsJson()));
    }
